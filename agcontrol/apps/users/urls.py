...
from .views import RegisterView, ProfileView, listUsers, EmailLoginTokenSerializer, LogoutView  # Importamos nuestras vistas personalizadas
...
urlpatterns = [
    ...
    path('api/auth/login/', EmailLoginTokenSerializer.as_view(), name='token_obtain_pair'),
